...
package dev.kobalt.svg2asset.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.svg2asset.jvm", "Application", "Executable JAR that is used to convert files."),
        Triple(
            "dev.kobalt.svg2asset.web",
            "Frontend",
