...
package dev.kobalt.svg2asset.web.legal

import dev.kobalt.svg2asset.web.markdown.fromMarkdown
...
object LegalRepository {
    ...
    val pageContent = ResourceRepository.getText("legal.md")!!.fromMarkdown()
    val pageRoute = "legal/"
